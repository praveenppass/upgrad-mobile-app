...
const autofillFromLinkedInQuery = gql`
	mutation AutofillFromLinkedIn($linkedInUrl: String!) {
		autofillProfile(linkedInUrl: $linkedInUrl) {
			firstName
			lastName
			email
			mobileNumber
...
export default autofillFromLinkedInQuery;

// Variables Interface
export interface IAutofillFromLinkedInQueryVariables {
	linkedInUrl: string;
}
...
export interface IAutofillFromLinkedInQuery {
